...
const existingPdfPath = "./Florida-Residential-Purchase-And-Sale-Agreement-Realtor-Version.pdf";
...
const pdfFunc = async () => {
    ...
    const legalDescription = pdfForm.getTextField("c Real Property The legal description is");
    const personalProperties = pdfForm.getTextField("Other Personal Property items included in this purchase are 1");
    const excludedPurchase = pdfForm.getTextField("e The following items are excluded from the purchase");
    ...
    const buyersInitialPage1 = pdfForm.getTextField("FloridaRealtorsFloridaBar5x");
    const buyerClosingDatePage1 = pdfForm.getTextField("Rev619  2017 Florida Realtors and The Florida Bar All rights reserved");
    const sellersInitialPage1 = pdfForm.getTextField("Sellers Initials");
    const sellerClosingDatePage1 = pdfForm.getTextField("Closing Date at the time established by the Closing Agent");
    seller.setText("1");
    buyer.setText("2");
    ...
    const financingWithIn = pdfForm.getTextField("after Effective Date and use good faith and diligent effort to obtain approval of a loan meeting the Financing terms");
    const buyersInitialPage2 = pdfForm.getTextField("FloridaRealtorsFloridaBar5x_2");
    const buyerClosingDatePage2 = pdfForm.getTextField("Rev619  2017 Florida Realtors and The Florida Bar All rights reserved_2");
    ...
    const permitLimitInNumber = pdfForm.getTextField("expired building permits and obtaining required building permits for any existing improvement for which a");
    const permitLimitInPercentage = pdfForm.getTextField("Text35");
    const costToBePaidByBuyer = pdfForm.getTextField("Other_2");
    const buyersInitialPage3 = pdfForm.getTextField("Commitment and after Closing an owners policy of title insurance see STANDARD A for terms shall be");
    const buyerClosingDatePage3 = pdfForm.getTextField("FloridaRealtorsFloridaBar5x_3");
    ...
    /************ THIRD PAGE ************/
    /************ FORTH PAGE ************/
    const abstractContinuationAmount = pdfForm.getTextField("if left blank then 20000 for abstract continuation or title search ordered or performed by Closing Agent");
    const homeWarrantyPlan = pdfForm.getTextField("warranty plan provides for repair or replacement of many of a homes mechanical systems and major builtin");
    const homeWarrantyPlanLimit = pdfForm.getTextField("Text36");
    const buyersInitialPage4 = pdfForm.getTextField("zone the Property is in whether flood insurance is required by Buyers lender and what restrictions apply to");
    const buyerClosingDatePage4 = pdfForm.getTextField("FloridaRealtorsFloridaBar5x_4");
    ...
    /************ FORTH PAGE ************/
    /************ FIFTH PAGE ************/
    const inspectionPeriod = pdfForm.getTextField("Period within which Buyer may at Buyers expense conduct General WDO and Permit Inspections");
    const buyersInitialPage5 = pdfForm.getTextField("Period inform Seller of any General Repair Items that are not in the condition required by bii below by");
    const buyerClosingDatePage5 = pdfForm.getTextField("FloridaRealtorsFloridaBar5x_5");
    ...
    /************ FIFTH PAGE ************/
    /************ SIXTH PAGE ************/
    const buyersInitialPage6 = pdfForm.getTextField("FloridaRealtorsFloridaBar5x_6");
    const buyerClosingDatePage6 = pdfForm.getTextField("Rev619  2017 Florida Realtors and The Florida Bar All rights reserved_3");
    ...
    /************ SIXTH PAGE ************/
    /************ SEVENTH PAGE ************/
    const buyersInitialPage7 = pdfForm.getTextField("or in any proceeding where Agent interpleads the subject matter of the escrow Agent shall recover reasonable");
    const buyerClosingDatePage7 = pdfForm.getTextField("FloridaRealtorsFloridaBar5x_7");
    ...
    /************ EIGHTH PAGE ************/
    const buyersInitialPage8 = pdfForm.getTextField("conducting the mediation In any litigation permitted by this Contract the prevailing party shall be entitled to recover");
    const buyerClosingDatePage8 = pdfForm.getTextField("FloridaRealtorsFloridaBar5x_8");
    ...
    /************ EIGHTH PAGE ************/
    /************ NINTH PAGE ************/
    const buyersInitialPage9 = pdfForm.getTextField("within 5 days after receipt of such information but no later than 5 days prior to Closing Date terminating this");
    const buyerClosingDatePage9 = pdfForm.getTextField("FloridaRealtorsFloridaBar5x_9");
    ...
    /************ NINTH PAGE ************/
    /************ TENTH PAGE ************/
    const buyersInitialPage10 = pdfForm.getTextField("date of receipt of such notification to cure the defect 3 if Seller fails to timely cure the defect the Deposit and all");
    const buyerClosingDatePage10 = pdfForm.getTextField("FloridaRealtorsFloridaBar5x_10");
    ...
    /************ TENTH PAGE ************/
    /************ ELEVENTH PAGE ************/
    const buyersInitialPage11 = pdfForm.getTextField("FloridaRealtorsFloridaBar5x_11");
    const buyerClosingDatePage11 = pdfForm.getTextField("Rev619  2017 Florida Realtors and The Florida Bar All rights reserved_4");
    ...
    const buyersInitialPage12 = pdfForm.getTextField("FloridaRealtorsFloridaBar5x_12");
    const buyerClosingDatePage12 = pdfForm.getTextField("Rev619  2017 Florida Realtors and The Florida Bar All rights reserved_5");
    ...
    const sellerAddress = pdfForm.getTextField("Sellers address for purposes of notice 1");
    ...
    const buyerClosingDatePage13 = pdfForm.getTextField("FloridaRealtorsFloridaBar5x_13");
    ...
    fs_1.default.writeFileSync(outputPdfPath, modifiedPdfBytes);
};
pdfFunc();
app.listen(port, () => {
    console.log(`⚡️[server]: Server is running at http://localhost:${outputPdfPath}`);
});
